...
/*  Created On : 18-jan-2018 00:36:16 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT `FK_Makes_Costumer` FOREIGN KEY (`ID_Costumer`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict,
	CONSTRAINT `FK_Makes_Costumer_02` FOREIGN KEY (`ID_Costumer`) REFERENCES `Costumer` (`ID_Costumer`) ON DELETE Restrict ON UPDATE Restrict,
	CONSTRAINT `FK_Makes_Order` FOREIGN KEY (`ID_Order`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict,
	CONSTRAINT `FK_Makes_T_Order` FOREIGN KEY (`ID_Order`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict,
	CONSTRAINT `FK_Makes_T_Order_02` FOREIGN KEY (`ID_Order`) REFERENCES `T_Order` (`ID_Order`) ON DELETE Restrict ON UPDATE Restrict
)
...
(
	...
	`ID_Warehouse` VARCHAR(50) 	,
	`Amount` VARCHAR(50) 	,
	CONSTRAINT `FK_Include_Order` FOREIGN KEY (`ID_Order`) REFERENCES  () ON DELETE Restrict ON UPDATE Restrict,
	CONSTRAINT `FK` FOREIGN KEY () REFERENCES  () ON DELETE No Action ON UPDATE No Action
)
